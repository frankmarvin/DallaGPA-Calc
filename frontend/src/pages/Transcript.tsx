...
export function Transcript() {
  ...
  if (isLoading) return <><Navigation /><div className="p-6">Loading transcript...</div></>;
  if (!data) return <><Navigation /><div className="p-6 text-red-500">No transcript data found</div></>;
